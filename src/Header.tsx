  ...
  return (
    <div css={Css.mx2.$}>
      <Link
        to={path}
        css={{
          ...Css.indigo700.b.noUnderline.pb1.transitionSlow.bb.bw(px(4)).bHollow
            .$,
          "&:hover": Css.bb.bw(px(4)).bIndigo100.indigo900.$,
        }}>
        {name}
      </Link>
    </div>
...
const routeLinks = routes.map((route, i) => (
  <HeaderNavItem key={i} {...route} />
));
