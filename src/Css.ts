...
class CssBuilder<T extends Properties1> {
  ...
  get bMidGray() { return this.add("borderColor", "#4A4A4A"); }
  get bLightGray() { return this.add("borderColor", "#777777"); }
  ...
  get bLemon() { return this.add("borderColor", "#F1B62B"); }
  get bTangerine() { return this.add("borderColor", "#E37C22"); }
  get bCherry() { return this.add("borderColor", "#DA0B36"); }
  get bRaspberry() { return this.add("borderColor", "#AF0B58"); }
  get bPlum() { return this.add("borderColor", "#7B3A88"); }
  get bBlueberry() { return this.add("borderColor", "#3F51B5"); }
  get bApple() { return this.add("borderColor", "#1CA176"); }
  get bKiwi() { return this.add("borderColor", "#7DB759"); }
  get bIndigo50() { return this.add("borderColor", "#E8EAF6"); }
  get bIndigo100() { return this.add("borderColor", "#C5CAE9"); }
  get bIndigo200() { return this.add("borderColor", "#9FA8DA"); }
  get bIndigo300() { return this.add("borderColor", "#7986CB"); }
  get bIndigo400() { return this.add("borderColor", "#5C6BC0"); }
  get bIndigo500() { return this.add("borderColor", "#3F51B5"); }
  get bIndigo600() { return this.add("borderColor", "#3949AB"); }
  get bIndigo700() { return this.add("borderColor", "#303F9F"); }
  get bIndigo800() { return this.add("borderColor", "#283593"); }
  get bIndigo900() { return this.add("borderColor", "#1A237E"); }
  get bBrightIndigo100() { return this.add("borderColor", "#8C9EFF"); }
  get bBrightIndigo200() { return this.add("borderColor", "#536DFE"); }
  get bBrightIndigo400() { return this.add("borderColor", "#3D5AFE"); }
  get bBrightIndigo700() { return this.add("borderColor", "#304FFE"); }
  ...
  get midGray() { return this.add("color", "#4A4A4A"); }
  get lightGray() { return this.add("color", "#777777"); }
  ...
  get lemon() { return this.add("color", "#F1B62B"); }
  get tangerine() { return this.add("color", "#E37C22"); }
  get cherry() { return this.add("color", "#DA0B36"); }
  get raspberry() { return this.add("color", "#AF0B58"); }
  get plum() { return this.add("color", "#7B3A88"); }
  get blueberry() { return this.add("color", "#3F51B5"); }
  get apple() { return this.add("color", "#1CA176"); }
  get kiwi() { return this.add("color", "#7DB759"); }
  get indigo50() { return this.add("color", "#E8EAF6"); }
  get indigo100() { return this.add("color", "#C5CAE9"); }
  get indigo200() { return this.add("color", "#9FA8DA"); }
  get indigo300() { return this.add("color", "#7986CB"); }
  get indigo400() { return this.add("color", "#5C6BC0"); }
  get indigo500() { return this.add("color", "#3F51B5"); }
  get indigo600() { return this.add("color", "#3949AB"); }
  get indigo700() { return this.add("color", "#303F9F"); }
  get indigo800() { return this.add("color", "#283593"); }
  get indigo900() { return this.add("color", "#1A237E"); }
  get brightIndigo100() { return this.add("color", "#8C9EFF"); }
  get brightIndigo200() { return this.add("color", "#536DFE"); }
  get brightIndigo400() { return this.add("color", "#3D5AFE"); }
  get brightIndigo700() { return this.add("color", "#304FFE"); }
  color(value: Properties["color"]) { return this.add("color", value); }
  get bgBlack() { return this.add("backgroundColor", "#353535"); }
  get bgMidGray() { return this.add("backgroundColor", "#4A4A4A"); }
  get bgLightGray() { return this.add("backgroundColor", "#777777"); }
  ...
  get bgLemon() { return this.add("backgroundColor", "#F1B62B"); }
  get bgTangerine() { return this.add("backgroundColor", "#E37C22"); }
  get bgCherry() { return this.add("backgroundColor", "#DA0B36"); }
  get bgRaspberry() { return this.add("backgroundColor", "#AF0B58"); }
  get bgPlum() { return this.add("backgroundColor", "#7B3A88"); }
  get bgBlueberry() { return this.add("backgroundColor", "#3F51B5"); }
  get bgApple() { return this.add("backgroundColor", "#1CA176"); }
  get bgKiwi() { return this.add("backgroundColor", "#7DB759"); }
  get bgIndigo50() { return this.add("backgroundColor", "#E8EAF6"); }
  get bgIndigo100() { return this.add("backgroundColor", "#C5CAE9"); }
  get bgIndigo200() { return this.add("backgroundColor", "#9FA8DA"); }
  get bgIndigo300() { return this.add("backgroundColor", "#7986CB"); }
  get bgIndigo400() { return this.add("backgroundColor", "#5C6BC0"); }
  get bgIndigo500() { return this.add("backgroundColor", "#3F51B5"); }
  get bgIndigo600() { return this.add("backgroundColor", "#3949AB"); }
  get bgIndigo700() { return this.add("backgroundColor", "#303F9F"); }
  get bgIndigo800() { return this.add("backgroundColor", "#283593"); }
  get bgIndigo900() { return this.add("backgroundColor", "#1A237E"); }
  get bgBrightIndigo100() { return this.add("backgroundColor", "#8C9EFF"); }
  get bgBrightIndigo200() { return this.add("backgroundColor", "#536DFE"); }
  get bgBrightIndigo400() { return this.add("backgroundColor", "#3D5AFE"); }
  get bgBrightIndigo700() { return this.add("backgroundColor", "#304FFE"); }
  bgColor(value: Properties["backgroundColor"]) { return this.add("backgroundColor", value); }
  get fBlack() { return this.add("fill", "#353535"); }
  get fMidGray() { return this.add("fill", "#4A4A4A"); }
  get fLightGray() { return this.add("fill", "#777777"); }
  ...
  get fLemon() { return this.add("fill", "#F1B62B"); }
  get fTangerine() { return this.add("fill", "#E37C22"); }
  get fCherry() { return this.add("fill", "#DA0B36"); }
  get fRaspberry() { return this.add("fill", "#AF0B58"); }
  get fPlum() { return this.add("fill", "#7B3A88"); }
  get fBlueberry() { return this.add("fill", "#3F51B5"); }
  get fApple() { return this.add("fill", "#1CA176"); }
  get fKiwi() { return this.add("fill", "#7DB759"); }
  get fIndigo50() { return this.add("fill", "#E8EAF6"); }
  get fIndigo100() { return this.add("fill", "#C5CAE9"); }
  get fIndigo200() { return this.add("fill", "#9FA8DA"); }
  get fIndigo300() { return this.add("fill", "#7986CB"); }
  get fIndigo400() { return this.add("fill", "#5C6BC0"); }
  get fIndigo500() { return this.add("fill", "#3F51B5"); }
  get fIndigo600() { return this.add("fill", "#3949AB"); }
  get fIndigo700() { return this.add("fill", "#303F9F"); }
  get fIndigo800() { return this.add("fill", "#283593"); }
  get fIndigo900() { return this.add("fill", "#1A237E"); }
  get fBrightIndigo100() { return this.add("fill", "#8C9EFF"); }
  get fBrightIndigo200() { return this.add("fill", "#536DFE"); }
  get fBrightIndigo400() { return this.add("fill", "#3D5AFE"); }
  get fBrightIndigo700() { return this.add("fill", "#304FFE"); }
  ...
  // animation
  get colorChangeBg() { return this.add("animation", "color-change-background 10s linear infinite; @keyframes color-change-background {0% {background-color: #F1B62B} 11% {background-color: #E37C22} 23% {background-color: #DA0B36} 37% {background-color: #AF0B58} 50% {background-color: #7B3A88} 64% {background-color: #3F51B5} 77% {background-color: #1CA176} 91% {background-color: #7DB759} 100% {background-color: #F1B62B}}"); }
  get colorChangeFill() { return this.add("animation", "color-change-fill 10s linear infinite; @keyframes color-change-fill {0% {fill: #F1B62B} 11% {fill: #E37C22} 23% {fill: #DA0B36} 37% {fill: #AF0B58} 50% {fill: #7B3A88} 64% {fill: #3F51B5} 77% {fill: #1CA176} 91% {fill: #7DB759} 100% {fill: #F1B62B}}"); }
